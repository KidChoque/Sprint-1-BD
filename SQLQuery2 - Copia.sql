...
SELECT Cliente.IdCliente,Cliente.Nome,Alugueis.DataAluguel,Alugueis.DataDevolucao,Modelos.NomeModelo FROM
           Alugueis 
		        JOIN Cliente ON Cliente.IdCliente = Alugueis.IdCliente
				 JOIN Veiculos ON Veiculos.IdVeiculos = Veiculos.IdModelos
				  JOIN Modelos ON Modelos.IdModelos = Veiculos.IdModelos
				   WHERE DataDevolucao = '2023-07-01'
